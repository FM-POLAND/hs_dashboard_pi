...
<p style="font-size:14px;color:#454545;font-weight:bold;">Idealny poziom: <span style="color:brown;"><b>-15</b> do  <b>-10dB</b></span>. Maksymalny pik w audio <span style="color:brown;"><b> -10dB</b>.</span></p>
<div>
...
<?php
    ...
    {
         exec('/opt/audiotest/record.sh');
         header("Refresh:0; url=index.php");
    }
?>
<script>
function func() {
    document.getElementById('runRec').value  = 'Nagrywanie audio, czekaj na zakończenie ... ';
...
<p style="margin-bottom:0px;"></p>
    ...
    <form method="post">
    <p>
    <input name="recAudio" type="submit" class="red" onclick="func()" id="runRec" type="button" value="Kliknij aby nagrać testowe audio 15 sec" style="height:45px;font-size:18px;"></input>
    </p>
    </form>
