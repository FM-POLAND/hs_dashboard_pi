...
name=$(curl -sl https://api.github.com/repos/SP0DZ/hotspot.dashboard.pi/releases/latest | jq -r .name)
published=$(curl -sl https://api.github.com/repos/SP0DZ/hotspot.dashboard.pi/releases/latest | jq -r .published_at)
body=$(curl -sl https://api.github.com/repos/SP0DZ/hotspot.dashboard.pi/releases/latest | jq -r .body)
