...
<center>
<fieldset style="box-shadow:0 0 10px #999; background-color:#d1d1d1; width:750px;margin-top:15px;margin-left:0px;margin-right:5px;font-size:13px;border-top-left-radius: 10px; border-top-right-radius: 10px;border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
<?php
...
<form method="post">
    <p>
         ...
         <center><button style="height: 60px; width: 100px;font-size:25px;" button name="button21">1</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button22">2</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button23">3</button></center>
         <center><button style="height: 60px; width: 100px;font-size:25px;" button name="button24">4</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button25">5</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button26">6</button></center>
         <center><button style="height: 60px; width: 100px;font-size:25px;" button name="button27">7</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button28">8</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button29">9</button></center>
         <center><button style="height: 60px; width: 100px;font-size:25px;" button name="button30">*</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button20">0</button><button style="height: 60px; width: 100px;font-size:25px;" button name="button31">#</button></center>
    </p>
    </form>
    <form method="post">
    <p>
        ...
        <button class="blue" style="height: 60px; width: 130px;font-size:16px;" button name="button3">TG 26078</button>
        <button class="blue" style="height: 60px; width: 130px;font-size:16px;" button name="button4">TG 999</button></br>
        <button class="blue" style="height: 60px; width: 130px;font-size:16px;" button name="button5">TG 91</button>
        <button class="blue" style="height: 60px; width: 130px;font-size:16px;" button name="button6">TG 26021</button>
        <button class="blue" style="height: 60px; width: 130px;font-size:16px;" button name="button7">TG 26062</button>
        <button class="blue" style="height: 60px; width: 130px;font-size:16px;" button name="button8">No TalkGroup</button>
       </center>
    ...
    <p>
        ...
        <center>
        <button class="green"  style="height: 60px; width: 130px;font-size:16px;" button name="button9">SVX IDENT</button>
        <button class="orange" style="height: 60px; width: 130px;font-size:16px;" button name="button10">PARROT</button>
        <button class="purple" style="height: 60px; width: 130px;font-size:16px;" button name="button11">EL-SR4DON</button>
        <button class="purple" style="height: 60px; width: 130px;font-size:16px;" button name="button12">EL-SR2C</button>
    </center>
    </p>
    </form>
    <form method="post">
